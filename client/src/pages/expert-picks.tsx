...
export default function ExpertPicks() {
  ...
  const expertPicks: ExpertPick[] = [
    ...
    },
    {
      ...
      estimatedCost: 52000,
      popularity: 91,
      reasons: ["Coyote V8 engine", "Manual transmission available", "Modern reliability"],
      pros: ["Great value performance", "Parts availability", "Strong aftermarket"],
      cons: ["Fuel consumption", "Interior quality", "Heavy weight"],
      expertTip: "Look for Performance Pack models with Recaro seats and Brembo brakes. Manual transmission preferred.",
    ...
    },
    {
      ...
      estimatedCost: 48000,
      popularity: 87,
      reasons: ["LS3 V8 power", "Track-capable suspension", "Distinctive styling"],
      pros: ["Raw V8 sound", "Track performance", "Competitive pricing"],
      cons: ["Visibility issues", "Interior space", "Fuel economy"],
      expertTip: "1LE package cars are track weapons. Check for track use and tire wear patterns.",
      expertName: "Tony Martinez",
      imageUrl: "/api/placeholder/400/250"
    },
    {
      id: "9",
      ...
      estimatedCost: 45000,
      popularity: 83,
      reasons: ["HEMI V8 engine", "Classic muscle styling", "Comfortable interior"],
      pros: ["Retro appeal", "Comfortable daily driver", "Strong V8 torque"],
      cons: ["Weight penalty", "Fuel consumption", "Handling limitations"],
      expertTip: "R/T is sweet spot for value. Avoid Scat Pack unless you need the extra power.",
      expertName: "Rachel Davis",
      imageUrl: "/api/placeholder/400/250"
    },
    {
      id: "10",
      ...
      estimatedCost: 68000,
      popularity: 94,
      reasons: ["LS3 V8 performance", "Supercar dynamics", "American icon"],
      pros: ["Incredible performance", "Daily usable", "Strong resale"],
      cons: ["Interior quality", "Storage space", "Maintenance costs"],
      expertTip: "Z51 package worth the premium for track use. Manual transmission becoming rare.",
      expertName: "Steve Anderson",
      imageUrl: "/api/placeholder/400/250"
    }
  ];
