        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/pricing" className="text-amber-400 text-sm font-medium">Pricing</Link>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-6 border-t border-gray-800/50">
              <div className="flex flex-col space-y-4">
                ...
                <Link href="/pricing" className="text-amber-400 py-3 text-sm font-medium">Pricing</Link>
